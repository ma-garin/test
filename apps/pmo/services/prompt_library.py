...
DEFAULT_ENTRIES: tuple[PromptEntry, ...] = (
    PromptEntry(
        ...
        body=(
            "以下の遅延について、事実／推定原因／後続工程への影響／取りうる打ち手を分けて整理してください。\n"
            "対象: "
        ),
        intent="delay",
        is_builtin=True,
    ...
    PromptEntry(
        ...
        body=(
            "現在のリスク一覧について、発生確率・影響度・兆候となる監視指標・一次対応を整理してください。\n"
            "観点: "
        ),
        intent="risk",
        is_builtin=True,
    ...
    PromptEntry(
        ...
        body=(
            "次の課題について、エスカレーションの要否と、その判断に必要な根拠を整理してください。\n"
            "課題: "
        ),
        intent="issue",
        is_builtin=True,
    ...
    PromptEntry(
        ...
        body=(
            "今回のテスト結果から、不具合の傾向・重大度別の件数・是正措置案を含む品質レポートの下書きを作成してください。\n"
            "対象期間: "
        ),
        intent="quality",
        is_builtin=True,
    ...
    PromptEntry(
        ...
        body=(
            "次の変更要求について、スコープ・スケジュール・コスト・品質への影響を分けて評価してください。\n"
            "変更内容: "
        ),
        intent="change",
        is_builtin=True,
    ...
    PromptEntry(
        ...
        body=(
            "今週の状況から、実績／来週の予定／課題とリスク／関係者への依頼事項の 4 区分で"
            "週次報告の骨子を作成してください。\n"
            "補足: "
        ),
        intent="general",
