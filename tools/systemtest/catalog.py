...
VIEWPOINTS: tuple[Viewpoint, ...] = (
    ...
    Viewpoint(
        ...
        (
            ...
            {
                "m": "POST",
                "u": "projects:task_create",
                "form": "task",
                "effect": "projects.WbsTask",
                "expect": {"write": True},
            },
            {
                "m": "POST",
    ...
    Viewpoint(
        ...
        (
            ...
            {
                "m": "POST",
                "u": "projects:issue_create",
                "form": "issue",
                "effect": "projects.Issue",
                "expect": {"write": True},
            },
            {
                "m": "POST",
    ...
    Viewpoint(
        ...
        (
            ...
            {
                "m": "POST",
                "u": "projects:risk_create",
                "form": "risk",
                "effect": "projects.Risk",
                "expect": {"write": True},
            },
            {
                "m": "GET",
    ...
    Viewpoint(
        ...
        (
            ...
            {
                "m": "POST",
                "u": "projects:defect_create",
                "form": "defect",
                "effect": "projects.Defect",
                "expect": {"write": True},
            },
            {
                "m": "POST",
...
PERSONAS: tuple[Persona, ...] = (
    ...
    Persona(
        ...
        "pmo",
        "横断PMO・8年目",
        "大手SIerで5案件を横断して見るPMO。週次で全案件の状況を集約する",
        "案件間で数字の粒度が揃うこと",
    ),
    Persona(
        "P02",
    ...
    Persona(
        "P20", "change", "要件変更BA", "業務要件の変更を仕様へ落とす", "影響を受ける成果物が特定できること"
    ),
    Persona(
        "P21",
        "change",
    ...
    Persona(
        "P22", "change", "緊急変更オンコール", "夜間・休日の緊急変更を捌く", "最短手順で記録だけは残せること"
    ),
    Persona(
        "P23",
        "change",
    ...
    Persona(
        "P26", "viewer", "顧客側担当者", "発注者として進捗を確認する", "自分に関係する範囲だけ見えること"
    ),
    Persona(
        "P27",
        "viewer",
    ...
    Persona(
        "P30", "viewer", "営業担当", "類似案件の実績を提案材料として探す", "似た案件を探し当てられること"
    ),
    # --- テナント管理者 ---
    Persona(
        "P31",
